...
////////////////////////////////////////
  ...
  #define TEENSY_PWM_VERSION             F("Teensy_PWM v1.0.0")

  #define TEENSY_PWM_VERSION_MAJOR       1
  #define TEENSY_PWM_VERSION_MINOR       0
  #define TEENSY_PWM_VERSION_PATCH       0

  #define TEENSY_PWM_VERSION_INT         1000000
#endif
...
class Teensy_PWM
{
  ...
  private:
    ...
    bool setupPWM(uint32_t pin, uint32_t frequency, uint16_t dutycycle)
    {
      ...
      PWM_LOGDEBUG5(F("setupPWM: Mapping dutycycle ="), dutycycle, F("to newDC ="), newDC, F("for _resolution ="), _resolution);
